...
- Allow subscriptions when the bot is not a chat administrator, while retaining strict membership checks in chats where Telegram confirms that the bot is an administrator.
