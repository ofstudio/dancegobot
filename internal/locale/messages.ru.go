...
`
	...
	LinkSubscribe    = "Подписаться"
	LinkResubscribe  = "Подписаться заново"
	...
	SubscriptionUnavailable      = "Подписка недоступна для этого мероприятия."
	SubscriptionPrompt           = "Подписаться на %s?\n\nВы будете получать уведомления о новых мероприятиях в этом чате."
	SubscriptionPromptChat       = "Подписаться на этот чат?\n\nВы будете получать уведомления о новых мероприятиях в этом чате."
	SubscriptionSubscribed       = "Вы подписались на новые мероприятия в %s."
	SubscriptionSubscribedChat   = "Вы подписались на новые мероприятия в этом чате."
	SubscriptionUnsubscribed     = "Вы отписались от %s."
	SubscriptionUnsubscribedChat = "Вы отписались от этого чата."
